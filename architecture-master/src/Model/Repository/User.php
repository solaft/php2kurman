...
class User
{
    ...
    /*public function findbyid(string $User, int $id)
    {
        $entity = $this->identityMap->find($User, $id);
        if ($entity !== null {
            return $entity;
        }
        ...
        return $entity;
                    ...
                    //Вот тут вроде применение паттерна
    ...
    /*public function findbylogin(string $User, string $login)
    {
        $entity = $this->identityMap->find($User, $login);
        if ($entity !== null {
            return $entity;
        }
        $entity = $this->userMapper->findbyid($login);
        if ($entity === null) {
            return null;
        }
        $this->identityMap->add($entity);
